module "vpc" {
  source = "git::https://github.com/SurendraBabuC/tf-module-vpc.git"
...
module "docdb" {
  source = "git::https://github.com/SurendraBabuC/tf-module-docdb.git"
...
module "rds" {
  source = "git::https://github.com/SurendraBabuC/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/SurendraBabuC/tf-module-elasticcache.git"
